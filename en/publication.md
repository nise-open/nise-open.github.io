...
- **Processor-Sharing Internet of Things Architecture for Large-scale Deployment** [SenSys 2024] <span class="gold-badge">_(Best Paper Award)_</span>
...
- **μMan: Towards Device-Agnostic Power Management for Battery-free IoT**
  ...
  _23rd ACM Conference on Embedded Networked Sensor Systems_
...
- **Domination Strategies for Free-Riding in Cross-Silo FL-based Caching**
  ...
  _IEEE International Conference on Acoustics, Speech and Signal Processing_
...
- **LEGO+: Redefining the Redundancy Removal for IoT Sensing Edge-End Systems**
  ...
  _23rd ACM International Conference on Mobile Systems, Applications, and Services_
...
- **Hedgehog: Pushing the Range Limits of Ultrasonic Microphone Jammers**
  ...
  _31st Annual International Conference on Mobile Computing and Networking_
...
- **Unilateral Control for Social Welfare of Iterated Game in Mobile Crowdsensing**
  ...
  _Journal of Computer Science and Technology_
...
- **BaroAuth: Harnessing Ear Canal Deformation for Speaking User Authentication on Earbuds**
  ...
  _45th IEEE International Conference on Distributed Computing Systems_
...
- **The What's Next IoT Architecture for Large-Scale Deployment**
  ...
  _GetMobile: Mobile Computing and Communications_
...
- **Sisyphus: Redefining Low Power for LoRa Receiver**
  ...
  _30th Annual International Conference on Mobile Computing and Networking_
...
- **Processor-Sharing Internet of Things Architecture for Large-scale Deployment**
  ...
  _22nd ACM Conference on Embedded Networked Sensor Systems_

  _(SenSys 2024)_

  <span class="gold-badge">_(Best Paper Award)_</span>
...
- **Energy-Efficient Dynamic Configurable Datapath Architecture for IoT Devices**
  ...
  _Journal of Communications and Information Networks_
...
- **A Compact Impedance Matching Layer for Dual-Band Implantable Medical Devices**
  ...
  _IEEE Antennas and Wireless Propagation Letters_
...
- **Go Beyond RFID: Rethinking the Design of RFID Sensor Tags for Versatile Applications**
  ...
  _29th Annual International Conference on Mobile Computing and Networking_
...
- **μMote: Enabling Passive Chirp De-spreading and μW-level Long-Range Downlink for Backscatter Devices**
  ...
  _20th USENIX Symposium on Networked Systems Design and Implementation_
...
- **LEGO: Empowering Chip-Level Functionality Plug-and-Play for Next-Generation IoT Devices**
  ...
  _28th ACM International Conference on Architectural Support for Programming Languages and Operating Systems_
...
- **Cross-session Specific Emitter Identification using Adversarial Domain Adaptation with Wasserstein distance**
  ...
  _26th International Conference on Pattern Recognition_
...
- **Online ECG Emotion Recognition for Unknown Subjects via Hypergraph-Based Transfer Learning**
  ...
  _31st International Joint Conference on Artificial Intelligence_
...
- **Passive DSSS: Empowering the Downlink Communication for Backscatter Systems**
  ...
  _19th USENIX Symposium on Networked Systems Design and Implementation_
...
- **Research on Security Defense System of Industrial Control Network**
  ...
  _2nd IEEE International Conference on Information Technology, Big Data and Artificial Intelligence_
...
- **Internet-of-microchips: direct radio-to-bus communication with SPI backscatter**
  ...
  _26th Annual International Conference on Mobile Computing and Networking_
...
- **RUPS: Fixing Relative Distances among Urban Vehicles with Context-Aware Trajectories**
  ...
  _IEEE International Parallel and Distributed Processing Symposium_
