...
> [!IMPORTANT]
> All new pages and elements must strictly follow this guide. Do not introduce independent color systems outside of this specification.
...
> [!CAUTION]
> The following color systems have been removed from the spec. Do not use them in new content:
...
> [!TIP]
> Cards intentionally use blue-tinted shadows (`rgba(0,62,153,…)`) instead of pure black. This is the key detail that separates "premium" from "generic".
